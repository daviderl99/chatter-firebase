export default function SettingsIcon({ className = "", ...props }) {
  return (
    <svg
      ...
      className={`lucide lucide-settings-icon lucide-settings ${className}`.trim()}
      {...props}
    >
      <path
        d="M9.671 4.136a2.34 2.34 0 0 1 4.659 0 2.34 2.34 0 0 0 3.319 1.915 2.34 2.34
        ...
        2.34 0 0 0 0-3.831A2.34 2.34 0 0 1 6.35 6.051a2.34 2.34 0 0 0 3.319-1.915"
      />
